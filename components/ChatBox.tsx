    ...
    <div className="surface flex h-full w-full flex-col rounded-3xl p-3 sm:p-4">
      ...
      >
        ...
        <button
          ...
          className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-gradient-brand text-[#1b262b] transition-opacity disabled:opacity-40"
        >
          <SendIcon />
        </button>
      </form>
    ...
    <div className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
      <div
        className={`max-w-[88%] rounded-2xl px-4 py-2.5 text-sm leading-relaxed ${
          isUser
            ? "whitespace-pre-wrap bg-gradient-brand text-[#1b262b]"
